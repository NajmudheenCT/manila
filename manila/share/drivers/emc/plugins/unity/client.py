...
class UnityClient(object):
    ...
    def create_dns_server(self, nas_server, domain, dns_ip):
        try:
    ...
    def create_interface(self, nas_server, ip_addr, netmask, gateway, ports,
                         vlan_id=None):
    ...
    def enable_cifs_service(self, nas_server, domain, username, password):
        try:
    ...
    def enable_nfs_service(self, nas_server):
        try:
    ...
    def create_snapshot(self, filesystem, name):
    ...
    def cifs_clear_access(self, share_name):
        share = self.system.get_cifs_share(name=share_name)
        share.clear_access()

    def nfs_clear_access(self, share_name):
