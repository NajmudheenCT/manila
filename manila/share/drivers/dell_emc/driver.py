...
class EMCShareDriver(driver.ShareDriver):
    ...
    def choose_share_server_compatible_with_share(self, context, share_servers,
        ...
        """
        try:
            return self.plugin.choose_share_server_compatible_with_share(
                context, share_servers, share,
                snapshot=snapshot, share_group=share_group,
            )
        except NotImplementedError:
            return super(EMCShareDriver,
                         self).choose_share_server_compatible_with_share(
                context, share_servers, share,
                snapshot=snapshot, share_group=share_group,
            )
    ...
    def choose_share_server_compatible_with_share_group(
        ...
        try:
            ...
            return super(EMCShareDriver,
                         self).choose_share_server_compatible_with_share_group(
                context, share_servers, share_group_ref,
                share_group_snapshot=share_group_snapshot,
            )
